...
const Search = () => {
    ...
    return (<div className="mt-4 flex w-full">
            <input type="text" value={terms} onChange={(ev) => setTerms(ev.target.value)} className="border w-11/12 text-white font-mono rounded-sm py-2 px-2 border-slate-600/60 bg-white/20" placeholder="Search anything, Example: Tesla"/>
