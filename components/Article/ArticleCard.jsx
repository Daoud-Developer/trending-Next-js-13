...
const ArticleCard = ({ article, onClick }) => {
    ...
    return (<div className="article-card group" onClick={() => onClick(article)}>
            <img src={article.urlToImage} onLoad={() => setHasImageLoaded(prev => !prev)} className={`article-card__image ${hasImageLoaded ? 'block' : 'hidden'}`} alt="article title"/>
