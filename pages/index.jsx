...
const NewsPage = () => {
    ...
    return (<div className="flex min-h-screen mb-5 relative flex-col items-center">
      <Navbar />

      <header className="w-full mt-4">
        <div className="flex flex-col justify-center items-center w-full">
          <PageTitle title="Trending Now" subtitle="only the top headlines"/>
      ...
      <main className="flex flex-col my-10 md:px-0 py-2 px-5 md:w-7/12 w-full justify-center items-center">
        ...
        {error ?
            ...
            : (<>
              ...
              {!loading && news.map((article, index) => (<ArticleCard key={index} article={article} onClick={(article) => setArticle(article)}/>))}
            </>)}
      </main>
